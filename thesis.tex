...
\begin{itemize}
    ...
    \item Número de Componentes: Máximo número de componentes (palabras) en la matriz de \acrshort{tfidf}\index{TF-IDF}. Las palabras menos relevantes se descartán si superan este número.
    \item Número de features: Al número de componentes al que reducir los componentes usando \acrshort{lsa}\index{LSA}
\end{itemize}
